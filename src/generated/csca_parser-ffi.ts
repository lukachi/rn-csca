...
interface NativeModuleInterface {
  ...
  ubrn_uniffi_csca_parser_fn_func_parse_ldif(
    data: Uint8Array,
    uniffi_out_err: UniffiRustCallStatus
  ): Uint8Array;
  ubrn_uniffi_csca_parser_fn_func_parse_ldif_string(
    data: Uint8Array,
    uniffi_out_err: UniffiRustCallStatus
  ): Uint8Array;
  ubrn_uniffi_csca_parser_fn_func_parse_pem(
    data: Uint8Array,
    uniffi_out_err: UniffiRustCallStatus
  ): Uint8Array;
  ubrn_uniffi_csca_parser_fn_func_parse_pem_string(
    data: Uint8Array,
    uniffi_out_err: UniffiRustCallStatus
  ): Uint8Array;
  ...
  ubrn_uniffi_csca_parser_checksum_func_parse_pem(): number;
  ubrn_uniffi_csca_parser_checksum_func_parse_pem_string(): number;
  ubrn_ffi_csca_parser_uniffi_contract_version(): number;
}

// Casting globalThis to any allows us to look for `NativeCscaParser`
// if it was added via JSI.
//
// We use a getter here rather than simply `globalThis.NativeCscaParser` so that
// if/when the startup sequence isn't just so, an empty value isn't inadvertantly cached.
const getter: () => NativeModuleInterface = () =>
  (globalThis as any).NativeCscaParser;
