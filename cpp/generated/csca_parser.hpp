...
protected:
  ...
  jsi::Value cpp_uniffi_internal_fn_func_ffi__arraybuffer_to_string(
      jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
      size_t count);
  jsi::Value cpp_uniffi_csca_parser_fn_func_build_cert_tree_and_gen_proof(
      jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
      size_t count);
  jsi::Value cpp_uniffi_csca_parser_fn_func_build_cert_tree_root(
      jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
      size_t count);
  ...
  jsi::Value cpp_uniffi_csca_parser_fn_func_parse_ldif(
      jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
      size_t count);
  jsi::Value cpp_uniffi_csca_parser_fn_func_parse_ldif_string(
      jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
      size_t count);
  jsi::Value cpp_uniffi_csca_parser_fn_func_parse_pem(jsi::Runtime &rt,
  ...
  jsi::Value cpp_uniffi_csca_parser_fn_func_parse_pem_string(
      jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
      size_t count);
  jsi::Value cpp_uniffi_csca_parser_checksum_func_build_cert_tree_and_gen_proof(
      jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
      size_t count);
  jsi::Value cpp_uniffi_csca_parser_checksum_func_build_cert_tree_root(
      jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
      size_t count);
  ...
  jsi::Value cpp_uniffi_csca_parser_checksum_func_parse_ldif(
      jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
      size_t count);
  jsi::Value cpp_uniffi_csca_parser_checksum_func_parse_ldif_string(
      jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
      size_t count);
  jsi::Value cpp_uniffi_csca_parser_checksum_func_parse_pem(
      jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
      size_t count);
  jsi::Value cpp_uniffi_csca_parser_checksum_func_parse_pem_string(
      jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
      size_t count);
  jsi::Value cpp_ffi_csca_parser_uniffi_contract_version(
      jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
      size_t count);
...
public:
   ...
   *
   * React Native must call `NativeCscaParser.registerModule(rt, callInvoker)`
   ...
   * be the case.
   *
   * Clients should call `NativeCscaParser.unregisterModule(rt)` after final use
   * where possible.
   */
